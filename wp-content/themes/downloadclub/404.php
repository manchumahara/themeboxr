<?php
	...
	get_header();
?>
    <main class="page-404-warp">
        <div class="container">
            <div class="row">
                <div class="col-md-6 align-self-center 404-svg-image">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <p><?php _e( "The page you are looking for does not exist. How you got here is a mystery. But maybe try looking again or search using the form below.", 'downloadclub' ); ?>
                    </p>
                    <?php get_search_form(); ?>
                </div>
            </div>
